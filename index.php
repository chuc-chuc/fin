    ...
    <div class="relative h-screen w-full">
        ...
        <main class="dark:bg-gray-900 relative">
            <div class="flex flex-col justify-center items-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
                ...
                <!-- Card -->
                <div
                    class="justify-center items-center w-full bg-white rounded-lg shadow lg:flex md:mt-0 lg:max-w-screen-lg 2xl:max:max-w-screen-lg xl:p-0 dark:bg-gray-800">
                    ...
                    <div class="p-6 space-y-8 w-full sm:p-8 lg:p-16 lg:py-0">
                        ...
                        <form id="miFormulario">
                            <div class="bg-gray-200 rounded-lg py-12 p-2 sm:px-12 shadow-lg">
