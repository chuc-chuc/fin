								...
								<div class="space-y-3">
									<div>
										...
										<div class="relative mt-1 hover:-translate-y-0.5">
											<input
												...
												type="text" placeholder="usuario" name="email" id="email" required>
											<div class="absolute left-0 inset-y-0 flex items-center">
												<svg xmlns="http://www.w3.org/2000/svg"
													class="h-7 w-7 ml-3 text-gray-500 p-1" viewBox="0 0 20 20"
													fill="currentColor">
													<path
									...
									<div>
										...
										<div class="relative mt-1 hover:-translate-y-0.5">
											<input
												...
												type="password" placeholder="clave" name="password" id="password" required>
											<div class="absolute left-0 inset-y-0 flex items-center">
												<svg xmlns="http://www.w3.org/2000/svg"
													class="h-7 w-7 ml-3 text-gray-500 p-1" viewBox="0 0 20 20"
													fill="currentColor">
									...
									<div>
										<button type="submit" name="submit" id="submit"
											class="w-full flex justify-center text-white py-2.5 px-4 rounded-lg bg-red-600 hover:bg-indigo-600 shadow hover:shadow-lg font-medium mt-8">
											Iniciar Sesión
										</button>
									</div>
								</div>
				...
				success: function (response) {
					...
					if (response.status === 'Listo') {
						Swal.fire({
							...
							window.location.href = 'vista.php?ruta=menu';
						});
					} else {
						Swal.fire({
							icon: 'error',
							title: 'Error',
							text: response.message, // Usamos el mensaje que viene del servidor
