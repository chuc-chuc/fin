    ...
    <body>
        <script>
            Swal.fire({ // Mostrar mensaje de bienvenida
                ...
                window.location.href = 'view/menu.php?ruta=menu'; // Redirecciona después de cerrar el mensaje
            });
        </script>
    </body>
    ...
    <div class="relative h-screen w-full">
        ...
        <main class="dark:bg-gray-900 relative">
            <div class="flex flex-col justify-center items-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
                <div class="flex-container flex justify-start mb-3">

                </div>
                <!-- Card -->
                <div
                    class="justify-center items-center w-full bg-white rounded-lg shadow lg:flex md:mt-0 lg:max-w-screen-lg xl:max:max-w-screen-lg xl:p-0 dark:bg-gray-800">
                    <div class="hidden w-2/3 lg:flex">
                        <img class="rounded-l-lg" src="images/authentication/login.jpg" alt="login image" />
                    </div>
                    <div class="p-2 space-y-8 w-full sm:p-4 lg:px-10 lg:py-0">
                        <div class="flex-container flex justify-start mb-3">
                        ...
                        <form id="miFormulario">
                            <div class="bg-gray-200 rounded-lg py-12 p-2 sm:px-5 shadow-lg">
                ...
                success: function(response) {
                    ...
                    if (response == 'Listo') {
                        ...
                        Swal.fire({
                            ...
                            confirmButtonColor: '#3085d6' // Agrega un color al botón de confirmación
                        });
                    }
                },
                error: function() {
                    Swal.fire({
                        ...
                        confirmButtonColor: '#d33' // Otro ejemplo de color de botón
                    });
                }
            });
        });
