...
<main>
    <div class="">
        <div class="w-full min-h-screen bg-blue-50">
            <h1 class="font-bold text-xl text-center md:text-3xl mb-4">Bienvenido <span class="text-red-500">Menu</span></h1>
            ...
            <div class="flex flex-wrap justify-center">
                ...
                ?>
                    <div class="flex flex-col bg-white rounded-lg shadow-md w-full m-6 overflow-hidden sm:w-52">
                        ...
                        <a href="vista.php?ruta=caja_index" class="bg-blue-500 text-white p-3 text-center hover:bg-blue-800 transition-all duration-500">Ingresar</a>
                    </div>
                <?php
                }
                if ($app->acceso('caja')) {
